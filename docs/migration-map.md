...
| --- | --- | --- | --- |
| `../mergecom-frontend/src/` | `apps/web/src/` | Migrated visual identity; replaced prototype state/auth with routes, generated health client, and explicit development adapter | 1 complete |
